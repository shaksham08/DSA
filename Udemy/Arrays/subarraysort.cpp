...
if the input  array is already sorted, the function should return [-1,-1] otherwise return the start and end index of the smallest subarray
...
1. First SOrt the array and then check for both left and right element which is not on its correct place.
    Take two loops one in forward direction to check for first element which is not in place and then backward direction to check for the elmenet which is not in the place.
